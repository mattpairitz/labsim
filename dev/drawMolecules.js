...
getInitialState() {
 ...
 drawGroups(buff1, strong, ctx) {
    ...
    const pos2 = {x: 150, y: 50};
    const pos3 = {x: 250, y: 50};
    const pos4 = {x: 350, y: 50};
    const smRadius = 10;
    const lgRadius = 20;
    ...
    switch (buff1) {
        ...
        case "NH\u2084Cl":
            ...
            this.drawH2O(pos2.x, pos2.y, ctx);
            this.drawO(pos3.x, pos3.y, lgRadius, ctx);
            this.drawH(pos3.x + total, pos3.y, smRadius, ctx);
